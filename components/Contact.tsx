...
const Contact: React.FC = () => {
  ...
  return (
    <section ref={sectionRef} id="contact" className="relative w-full pt-24 pb-12 md:py-12 bg-[#050505] px-6 md:px-20 overflow-visible md:overflow-hidden">
      {/* Technical Background Decor */}
      <div className="absolute inset-0 bg-grid opacity-[0.02] pointer-events-none" />
      <div className="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-white/10 to-transparent" />
      
      <div className="max-w-7xl mx-auto relative overflow-visible md:overflow-visible">
          ...
          <div className="space-y-12 overflow-visible">
            ...
            <div className="flex space-x-4 pt-4">
              {[
                ...
                {
                  name: 'Twitter',
                  url: 'https://x.com/dannyfullstack',
                  icon: (
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
